...
class TestRegisterNodes(BlockchainTestCase):
    def test_valid_nodes(self):
        ...
        blockchain.register_node("http://127.0.0.1:8000")

        self.assertIn("127.0.0.1:8000", blockchain.node)
    ...
    def test_malformed_nodes(self):
        ...
        self.assertNotIn("127.0.0.1:8000", blockchain.node)
    ...
    def test_idempotency(self):
        ...
        assert len(blockchain.node) == 1


class TestBlocksAndtransaction(BlockchainTestCase):
    ...
    def test_block_resets_transaction(self):
        ...
        initial_length = len(self.blockchain.current_transaction)

        self.create_block()

        current_length = len(self.blockchain.current_transaction)
